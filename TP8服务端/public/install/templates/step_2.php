...
<head>
    ...
    <title>河马点餐系统 安装向导 - 配置数据文件</title>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="text" name="dbhost" id="dbhost" class="input" value="localhost"/>
                        <span class="cnote">本地数据库服务器地址, 一般为 localhost 或 127.0.0.1</span></td>
                </tr>
                <tr>
                    <td height="40" align="right">数据库名称：</td>
                    <td><input type="text" name="dbname" id="dbname" class="input" value="root"/></td>
                </tr>
                <tr>
                    <td width="30%" height="40" align="right">数据库端口：</td>
                    <td><input type="text" name="dbport" id="dbport" class="input" value="3306"/>
                        <span class="cnote">数据库服务器端口默认为：3306</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="testdata" value="true" checked="checked"/>是</td>
                </tr>
            </table>
        </div>
    </div>
